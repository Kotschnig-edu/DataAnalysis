...
\begin{itemize}[leftmargin=*]
    ...
    \item Validation method (holdout, time-series split, etc.): Time-based holdout split (80\% train, 20\% test) 
    ...
    \begin{itemize}
        ...
        indicating homoscedasticity (constant variance).
...
\caption{Variance, PCA and loading of data for each principle component.}
\label{fig:PCA}
\end{figure}
...
\caption{Dimension reduction visualization using PCA, t-SNE, or UMAP.}
\label{fig:PCA_UM}
\end{figure}
